          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="<?php echo e(url('admin/category')); ?>">View Category</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
...
<?php /**PATH C:\xampp\htdocs\ecommerce\resources\views/layouts/include/sidebar.blade.php ENDPATH**/ ?>